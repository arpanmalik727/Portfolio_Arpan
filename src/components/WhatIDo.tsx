        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                Developing robust web applications, high-performance REST APIs,
                and scalable backend architectures with clean code and normalized data models.
              </p>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                Building production-grade Generative AI applications, RAG pipelines,
                computer vision models, and LLM-powered developer tools.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
